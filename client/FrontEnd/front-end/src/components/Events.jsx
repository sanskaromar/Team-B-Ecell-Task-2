  ...
  return (
    <div className="">
      <div className="bg-grey-500 flex flex-col items-center sm:translate-y-10 sm:flex sm:flex-row sm:justify-center">{[[quiz,"Business quiz"],[quiz,"Panel Discussion"],[quiz,"IPL Auction"]].map(([imgsrc,title])=>(
        <div className="w-40 clip m-2 sm:w-52 relative flex justify-center cursor-pointer hover:scale-125 hover:duration-500 hover:z-50" key={title}>
          <img className=" w-40 sm:w-52 " src={imgsrc} alt=""/>
      ...
      <div className="flex flex-col items-center sm:flex sm:flex-row sm:justify-center">{[[quiz,"E-Talk"],[quiz,"B-Plan"]].map(([imgsrc,title])=>(
        <div className="w-40 m-2 sm:w-52 relative flex justify-center cursor-pointer hover:z-50 hover:scale-125 hover:duration-500" key={title}>
